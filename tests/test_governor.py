...
def test_tpm_pressure_blocks_before_rpm_does_on_groq(gov):
    """With 8,000 tokens/minute against 30 requests/minute, Groq runs out of
    tokens long before it runs out of requests."""
    _grant(gov, GROQ, 2000, 3000)  # reserves 6,250 of the 8,000
